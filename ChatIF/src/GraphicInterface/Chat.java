...
public class Chat extends javax.swing.JFrame {
    ...
    private static String chatGeral = "amq";
    ...
    private void initComponents() {
        ...
        membrosChat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "[amq]", "Aldir", "Bruno", "Fernanda", "Frutos", "Joao" }));
